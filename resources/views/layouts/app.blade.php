...
<body class="min-h-screen font-sans antialiased">
    ...
    <x-main with-nav full-width collapsed>
        <x-slot:sidebar drawer="main-drawer" collapsible class="bg-white text-dark shadow-xl mr-3" collapsed>
            <div class="hidden-when-collapsed text-center  mx-4 mt-4 font-black text-3xl text-[#003CA2]">Reclame Aqui</div>

            <div class="display-when-collapsed mx-4 mt-3 font-black text-2xl text-[#003CA2]">RA</div>
            ...
            <x-menu activate-by-route>
                @if (Gate::forUser(Auth::user())->allows('admin.view-any'))
                    ...
                    <x-menu-sub title="Cadastros" icon="o-plus">
                        ...
                        <x-menu-item title="Empresas" icon="o-building-office" link="{{ route('admin.empresas.index') }}" />
                        <x-menu-item title="Motivos" icon="o-book-open" link="{{ route('admin.motivos.index') }}" />
                    </x-menu-sub>
                ...
                @endif
                {{-- <x-menu-item title="Usuários" icon="o-user" link="{{ route('dashboard') }}" /> --}}
                <x-menu-item title="Reclamações" icon="o-exclamation-triangle" link="{{ route('dashboard') }}" />
