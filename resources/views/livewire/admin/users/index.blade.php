...
$inactiveUser = function ($id) {
    ...
    try {
        ...
        return $this->error('Não foi possivel inativar usuário.');
    }
};
...
$restoreUser = function ($id) {
    ...
    try {
        ...
        return $this->error('Não foi possivel reativar usuário.');
    }
};
...
<div>
    <div>
        <div class="flex flex-row justify-between items-center bg-gray-100 p-4 shadow rounded">
            <h1 class="font-bold text-gray-700">Administradores Cadastrados</h1>
            <x-button class="btn-sm btn-success" label="ADICIONAR ADMINISTRADOR" icon="o-plus"
